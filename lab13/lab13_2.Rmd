...
This code can be added to stand alone version of app. Tidyverse will get installed for users if it is not already installed.
```{r}
...
##### New file<- Rscript     Then add needed libraries, then add data you are using eg- Homerange, Then add code for app. Standalone version of app is now created!!!
# See plot_homerange.R and standalone app I created.R
...
# Session$onSessionEnded line in server function stops app running in background
